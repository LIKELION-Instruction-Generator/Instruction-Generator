    ...
    def _build_generation_prompt(
        ...
        *,
        ...
        return (
            ...
            "- short_answer must NOT include choice_count, options, or answer_index.\n"
            "- short_answer must include answer_text_open (1-2 sentence model answer) and scoring_keywords (2-4 key terms).\n"
            "- Every multiple-choice question must be single-answer only.\n"
